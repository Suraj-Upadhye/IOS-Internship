...
print("Height in inches: \(height.heightInInches), Height in centimeters: \(height.heightInCentimeters)")
print("Height in inches: \(height.heightInInches), Height in centimeters: \(height.heightInCentimeters)")
height.heightInCentimeters = 170.18
print("Height in inches: \(height.heightInInches), Height in centimeters: \(height.heightInCentimeters)")
height.heightInInches = 70
print("Height in inches: \(height.heightInInches), Height in centimeters: \(height.heightInCentimeters)")
height.heightInCentimeters = 177.8
print("Height in inches: \(height.heightInInches), Height in centimeters: \(height.heightInCentimeters)")
